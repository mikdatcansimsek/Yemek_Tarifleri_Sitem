            ...
            <table class="auto-style10">
                ...
                <tr>
                    <td class="auto-style11">
                        <asp:Image ID="Image1" runat="server" Height="218px" ImageUrl="~/resimler/mücver.png" Width="313px" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                ...
                <tr>
                    <td>
                        <table class="auto-style10">
                            ...
                            <tr>
                                <td style="text-align: left"><strong>Eklenme Tarihi:</strong>&nbsp;<asp:Label ID="Label12" runat="server" Text='<%# Eval("GununYemegiTarih") %>'></asp:Label>
                                </td>
                                <td style="text-align: right">&nbsp;</td>
                            </tr>
                        </table>
